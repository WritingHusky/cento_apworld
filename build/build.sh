...
#     eg: "v1.1.1" will name the bundle "tp_apworld-v1.1.1"
...
function mk_apworld() {
    ...
    rsync --progress \
        ...
        "${root}/" "${destdir}/cento"
    pushd "${destdir}"
    zip -9r "cento.apworld" "cento"
    popd

    rm --force --recursive "${destdir}/cento"
}
...
function cp_data() {
    ...
    # cp --verbose "${root}/Cento.yaml" ${destdir}
}
...
function main() {
    ...
    local bundle_base="cento_apworld"
