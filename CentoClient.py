...
class UndertaleCommandProcessor(ClientCommandProcessor):
    ...
    def _cmd_savepath(self, directory: str):
        ...
        if isinstance(self.ctx, UndertaleContext):
            ...
            self.output(
                "Changed to the following directory: " + self.ctx.save_game_folder
            )
    ...
    def _cmd_auto_patch(self, steaminstall: typing.Optional[str] = None):
        ...
        if isinstance(self.ctx, UndertaleContext):
            ...
            if (
                ...
                self.output(
                    "ERROR: Cannot find Undertale. Please rerun the command with the correct folder."
                ...
                for file_name in os.listdir(tempInstall):
                    if file_name != "steam_api.dll":
                        shutil.copy(
                            os.path.join(tempInstall, file_name),
...
class UndertaleContext(CommonContext):
    ...
    def patch_game(self):
        ...
        with open(
            os.path.expandvars(
                Utils.user_path("Undertale", "Custom Sprites", "Which Character.txt")
            ),
            "w",
        ) as f:
            f.writelines(
            ...
            for file in files:
                ...
                if "check.spot" in file:
                    ...
                    try:
                        ...
                        await ctx.send_msgs(
                            [{"cmd": "LocationChecks", "locations": sending}]
                        )
